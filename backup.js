...
lab2.factory('processMove', function() {   // TODO Fix IFs
  return function() {
    self.checkWins =  function(player1_choice, player2_choice) {
      ...
      /* Google is your friend in this situation ;) */
        return( self.getChoiceAsNumber(b) == 0 ? self.getChoiceAsNumber(a) :
          ( self.getChoiceAsNumber(b) == 1 ? (self.getChoiceAsNumber(a)+2)%3 : (self.getChoiceAsNumber(a)+1)%3));
...
lab2.controller('player2', function(processMove, $rootScope, $scope, $ionicModal, $ionicLoading, $ionicViewSwitcher, $state, $stateParams, navigation) {
  ...
  $scope.onNext = function (choice) {
    ...
    if($scope.processMove.checkWins($stateParams.player2_choice, choice) == 2){
      $scope.player2_wins++;
    }
